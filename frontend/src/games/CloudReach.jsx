        ...
        <div className="max-w-2xl w-full bg-white rounded-[32px] p-10 shadow-sm border border-slate-100">
          ...
          <div className="flex items-center gap-6 mb-10">
            ...
            <div>
              ...
              <p className="text-slate-500 font-medium">Therapy Benefit: Improves shoulder flexion/abduction, arm elevation, and reaction time.</p>
            </div>
          </div>
              ...
              <ul className="space-y-4 text-slate-600">
                <li className="flex gap-3 text-sm">
                  ...
                  <div>
                    ...
                    <p>Sit upright with your shoulders level and hand at chest height.</p>
                  </div>
                </li>
                <li className="flex gap-3 text-sm">
                ...
                <li className="flex gap-3 text-sm">
                  ...
                  <div>
                    ...
                    <p>Reach up slowly to click/tap the cloud when it appears.</p>
                  </div>
                </li>
                <li className="flex gap-3 text-sm">
                  ...
                  <div>
                    ...
                    <p>Pop the cloud and then return to the start zone.</p>
                  </div>
                </li>
              </ul>
            </div>
            ...
            <div className="p-8 space-y-6 overflow-y-auto max-h-[60vh]">
              ...
              <div className="space-y-3">
                <div className="flex justify-between">
                  ...
                  <span className="text-green-600 font-bold">{settings.sessionLength || 5}m</span>
                </div>
                <input 
              ...
              <div className="space-y-3">
                <div className="flex justify-between">
                  ...
                  <span className="text-green-600 font-bold">{settings.restInterval || 2}s</span>
                </div>
                <input 
